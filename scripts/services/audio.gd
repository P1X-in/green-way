...
func _ready():
    ...
    self.register_track("menu", preload("res://assets/music/Komiku - The promoters of capitalism.mp3"))
    self.register_track("game1", preload("res://assets/music/Komiku - Road 1 Chill.mp3"))
    self.register_track("game2", preload("res://assets/music/Komiku - Road 2 Chill.mp3"))
    self.register_track("game3", preload("res://assets/music/Komiku - Road 3 Chill.mp3"))
    self.register_track("game4", preload("res://assets/music/Komiku - Road 4 Chill.mp3"))
